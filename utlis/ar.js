export const ar = {
  ...
  aboutQararPage: {
    title: 'عن منصة "قرار"',
    description: 'منصة "قرار" هي منصة إلكترونية مُبتكرة تهدف إلى الحصول على مساندة المجتمع في مناقشة ' +
    ...
    importanceDescriptionOne: 'تخطو المملكة العربية السعودية' +
    ...
    importanceDescriptionTwo: 'من هنا، تأتي منصة "قرار" خدمة داعمة لهذا الاتجاه، حيث تم تصميمها' +
    ...
    register: 'التسجيل',
    registerDescription: 'حيث يمكن لأي فرد التسجيل في المنصة، ليتمكن من التفاعل مع الخدمات المُقدمة فيها.',
    interaction: 'تفاعل الجمهور',
    interactionDescription: 'يمكن من خلال المنصة طرح كل بنود أي نظام أو تشريع ما للجمهور، مع إتاحة التعليق والنقاش على أي بند.',
    filtration: 'الفلترة',
    filtrationDescription: 'يتمكن المستفيدون من المنصة من مراجعة ' +
    ...
    stimulus: 'التحفيز',
    stimulusDescription: 'توفر المنصة أدوات خاصة لتحفيز الجمهور' +
  ...
  decisionPage: {
    ...
    archivedDecisionsNotImplemented: 'قرارات لم يتم تطبيقها او تعديلها بعد الطرح وتعتبر مسودة للاطلاع',
