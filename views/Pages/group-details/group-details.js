...
class GroupDetails extends Component {
  render() {
    return (
      <React.Fragment>
        <Breadcrumb title="كل مجموعاتي" link="/client/groups" />
        <Container>
            ...
            <Row>
              <Col sm="12" md="8" lg="9">
                <div className="header-content">
                  ...
                  <div className="sub-header">
                    ...
                    <span>
                      أسندت لك لأنك عضو في مجموعة
                      <Link exact to="/client/decision" tag={RRNavLink}>
                        النقل و المواصلات
                      </Link>
                    </span>
                  </div>
              ...
              <Col sm="12" md="4" lg="3">
                <div className="cards">
                  <Row>
                    <Col xs="6">
                      <CardInfo type="صوت" number="5523" icon={likeIcon} />
                    </Col>
                    <Col xs="6">
                      <CardInfo
                        type="تعليق"
